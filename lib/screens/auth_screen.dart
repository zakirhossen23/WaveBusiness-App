...
class AuthScreenApp extends State<AuthScreen> {
  ...
  Future<void> LoginAccount() async {
    var url = Uri.parse(
        'https://cors-anyhere.herokuapp.com/https://test.i.tgcloud.io:14240/restpp/query/WaveData/Login?emailTXT=${Uri.encodeComponent(emailTXT.text)}&passwordTXT=${Uri.encodeComponent(passwordTXT.text)}');
